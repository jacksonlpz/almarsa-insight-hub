      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-8 lg:py-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-4">
            <div className="space-y-6">
              ...
              <p className="text-body leading-relaxed text-white/70 max-w-sm">
                Leading intellectual property and trademark agents providing comprehensive protection for your innovations and brands across the GCC and MENA region.
              </p>
              <div>
                <p className="mb-3 text-label-xs font-semibold uppercase tracking-wide text-white/80">Follow Us</p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-8">
            {/* Quick Links */}
            <div>
              <h3 className="mb-6 text-label-sm font-bold uppercase tracking-widest text-white">Quick Links</h3>
            ...
            {/* Services */}
            <div>
              <h3 className="mb-6 text-label-sm font-bold uppercase tracking-widest text-white">Our Services</h3>
              <nav className="space-y-4">
                <Link
                  to="/services#ip-registration-protection"
                  className="group flex items-center text-body text-white/70 transition-colors duration-base ease-emphasis hover:text-primary"
                >
                  <span>IP Registration &amp; Protection</span>
                  <ArrowUpRight className="ml-1 h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                </Link>
                <Link
                ...
                <Link
                  ...
                  className="group flex items-center text-body text-white/70 transition-colors duration-base ease-emphasis hover:text-primary"
                >
                  <span>Licensing &amp; Assignment</span>
                  <ArrowUpRight className="ml-1 h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                </Link>
                <Link
                  ...
                  className="group flex items-center text-body text-white/70 transition-colors duration-base ease-emphasis hover:text-primary"
                >
                  <span>Anti-Counterfeiting Programmes</span>
                  <ArrowUpRight className="ml-1 h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                </Link>
                <Link
                  ...
                  className="group flex items-center text-body text-white/70 transition-colors duration-base ease-emphasis hover:text-primary"
                >
                  <span>IP Strategy &amp; Advisory</span>
                  <ArrowUpRight className="ml-1 h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                </Link>
              </nav>
            </div>
            ...
            {/* Contact Info */}
            <div>
              <h3 className="mb-6 text-label-sm font-bold uppercase tracking-widest text-white">Get In Touch</h3>
              <div className="space-y-5">
                ...
                >
                  ...
                  <div>
                    <p className="text-label-xs font-medium uppercase tracking-wide text-white/80">Phone</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-label-xs font-medium uppercase tracking-wide text-white/80">Email</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-label-xs font-medium uppercase tracking-wide text-white/80">Office</p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 md:px-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-center text-body-xs text-white/80 md:text-left">
              &copy; {new Date().getFullYear()} Al Marsa Intellectual Property &amp; Trademark Agents. All rights reserved.
            </p>
